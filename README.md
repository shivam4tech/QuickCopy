...
**v1.5.0** — stable and ready for everyday use on Chrome and Firefox. Ships a dedicated PDF window with drag-to-copy, a zoom-safe capture overlay, and dual-language recognition (English + one additional language).
